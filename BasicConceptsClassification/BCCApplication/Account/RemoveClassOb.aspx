       ...
       <table style="width:100%;">
                <tr>
                    <td class="auto-style2">
                        ...
                        <center>
                            <select id="UnClassList" name="D1" size="15" runat="server"></select>
                        </center>
                    </td>
                    ...
                    <td class="auto-style1">
                        <asp:TextBox ID="SelectName" runat="server"></asp:TextBox> <br />
                        <asp:TextBox ID="SelectURL" runat="server"></asp:TextBox> <br />
                        <asp:TextBox ID="SelectConceptString" runat="server" Width="475px"></asp:TextBox> <br /><br />
